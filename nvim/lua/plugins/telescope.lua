return {
  {
    ...
    keys = {
      { '<leader>f,', '<Cmd>Telescope spell_suggest<CR>', desc = 'Find: commands' },
      ...
      { '<leader>ft', '<Cmd>Telescope treesitter<CR>', desc = 'Find: grep search' },
      { '<leader>fy', '<Cmd>Telescope current_buffer_fuzzy_find<CR>', desc = 'Find: open buffers' },
      { '<leader>lD', '<Cmd>Telescope diagnostics<CR>', desc = 'Find: diagnostic workspace' },
      { '<leader>lS', '<Cmd>Telescope lsp_dynamic_workspace_symbols<CR>', desc = 'Find: git status' },
      { '<leader>ld', '<Cmd>Telescope diagnostics bufnr=0<CR>', desc = 'Find: diagnostic buffer' },
      { '<leader>ls', '<Cmd>Telescope lsp_document_symbols<CR>', desc = 'Find: git status' },
      { 'gD', '<Cmd>Telescope lsp_type_definitions<CR>', desc = 'Find: references (LSP)' },
      { 'gd', '<Cmd>Telescope lsp_definitions<CR>', desc = 'Find: references (LSP)' },
